// yolo26 -> ONNX (opset 13) graph builder, shared by onnx_export26.cpp and the `yolo26 export`
// CLI. Takes a FUSED conv Provider (BN folded) + arch26 descriptors. See onnx_export26.cpp.
#pragma once
#include "net26.hpp"
#include "onnx.hpp"
#include <string>
...
inline Graph build_yolo26_onnx(Provider& prov, int64_t psa_n, const std::vector<int64_t>& cn,
                               const std::vector<int>& cc, const std::vector<int64_t>& ci,
                               int64_t nc, int64_t IMG) {
